...
export const INTERVALS: { [id: string]: ConceptDefinition } = {
    PU: {
        id: 'PU',
        name: 'Perfect Unison',
...
export const CHORDS: { [id: string]: ConceptDefinition } = {
    maj: {
        id: 'maj',
        name: 'Major Triad',
