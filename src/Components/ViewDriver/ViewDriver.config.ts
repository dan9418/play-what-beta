...
import { ViewDriverState } from "./ViewDriver";
...
export const DEFAULT_VIEW_DRIVER_STATE: ViewDriverState = {
    degree: DEGREES[0],
    accidental: ACCIDENTALS[2],
    octave: 4,
    conceptType: CONCEPT_TYPES[DEFAULT_CONCEPT_TYPE_INDEX],
    conceptIntervals: CONCEPT_TYPES[DEFAULT_CONCEPT_TYPE_INDEX].presets[0].intervals,
